...
public class WrappedMediaPlayer extends Player implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnSeekCompleteListener {
    ...
    //do dang truyen sang la %
    @Override
    void setBass(double bass) {
        Log.d("ASSSSSSSSSSSS bass : ", (3000 * bass - 1500) + "");
        mEqualizer.setBandLevel((short) (1), (short) (3000 * bass - 1500));
    }

    @Override
    void setTrebble(double trebble) {
        Log.d("ASSSSSSSSSSS trebble : ", (3000 * trebble - 1500) + "");
        mEqualizer.setBandLevel((short) (4), (short) (3000 * trebble - 1500));
    }
    ...
    private MediaPlayer createPlayer(Context context) {
        ...
        numberOfband = mEqualizer.getNumberOfBands();
